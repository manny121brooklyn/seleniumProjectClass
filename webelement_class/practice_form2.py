...
try:
    ...
    hobbies_reading_xpath = "//*[@id='hobbies-checkbox-2']/.."
...
# select state = NCR
    state = 'NCR'
    driver.find_element(By.ID, state_input).send_keys(state + Keys.TAB)
...
# select city = Delhi
    city = 'Delhi'
    driver.find_element(By.ID, city_input).send_keys(city + Keys.TAB)
